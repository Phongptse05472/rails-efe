...
ActiveRecord::Schema.define(version: 2020_08_25_064820) do
  ...
  create_table "course_perskills", force: :cascade do |t|
    t.string "int"
    t.bigint "course_id"
    t.bigint "skill_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["course_id"], name: "index_course_perskills_on_course_id"
    t.index ["skill_id"], name: "index_course_perskills_on_skill_id"
  end
